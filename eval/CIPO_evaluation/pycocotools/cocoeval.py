...
class COCOeval:
    ...
    def __init__(self, cocoGt=None, cocoDt=None, iouType='bbox'):
        ...
        if not cocoGt is None:
            self.params.imgIds = sorted(list(cocoGt.imgs.keys()))
    ...
    def computeIoU(self, imgId):
        ...
        if p.useCats:
            ...
            gt = [_ for _ in self._gts[imgId]]
            dt = [_ for _ in self._dts[imgId]]
